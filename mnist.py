...
def data_mnist(one_hot=True):
    ...
    if gv.args.dataset == 'MNIST':
        ...
        X_train, y_train = load_fmnist('C:\\Users\\Null-existence-devil\\Desktop\\study\\data', kind='train')
        X_test, y_test = load_fmnist('C:\\Users\\Null-existence-devil\\Desktop\\study\\data', kind='t10k')
